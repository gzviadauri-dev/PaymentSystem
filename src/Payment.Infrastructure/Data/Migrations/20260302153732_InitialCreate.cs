        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CHK_Balance_NonNegative", "[Amount] >= 0");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MonthlyPaymentStates", x => x.CorrelationId);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MonthlyPaymentStates_CurrentState",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Payments_ExternalPaymentId_ProviderId",
                table: "Payments",
                columns: new[] { "ExternalPaymentId", "ProviderId" },
                unique: true,
